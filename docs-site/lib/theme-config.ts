...
export const siteConfig = {
  // Site metadata
  name: 'Nimbus Docs',
  description: 'Documentation for Nimbus — the cloud platform with a built-in coding agent',
  ...
  // Navigation links (no GitHub — Nimbus is not an open-source app)
  links: {
    github: '',
  ...
  footer: {
    companyName: 'Nimbus',
    links: [
      { label: 'Website', href: 'https://nimbus.dev' },
    ],
  },
}
